        ...
        <div class="">
            <form action="{{ route('tarian.store') }}" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="tarian_code" required>
                </div>
                <div class="form-group">
                    <label>Nama Tarian: </label>
                    <input type="text" class="form-control" name="tarian_name" required>
                </div>
                <div class="form-group">
                    <label>Tipe Tarian: </label>
                    <input type="text" class="form-control" name="tipe_tarian" required>
                </div>
                <div class="form-group">
                    <label for="type">Pencipta Tari: </label>
                    <select class="form-select" name="pencipta_tari" id="type" required>
                        @foreach ($tarian as $tari)  
                            <option value="{{ $tari->pencipta->id }}">{{ $tari->pencipta->pencipta_name }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="form-group">
